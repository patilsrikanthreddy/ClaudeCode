 ...
 */
function validatePOFormat(poNumber: string): { isValid: boolean; message: string } {
 ...
 */
function checkPOUniqueness(poNumber: string, currentRecordId?: string): boolean {
    try {
...
export function fieldChanged(context: EntryPoints.Client.fieldChangedContext): void {
    try {
        ...
        const poNumber = currentRecord.getValue({ fieldId: 'tranid' }) as string;
 ...
 */
export function validateField(context: EntryPoints.Client.validateFieldContext): boolean {
    try {
        const currentRecord = context.currentRecord;
        const fieldId = context.fieldId;
 ...
 */
export function validateLine(context: EntryPoints.Client.validateLineContext): boolean {
